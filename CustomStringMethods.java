public class CustomStringMethods {
    ...
    public String funnyString(String str, int idx) {
      String silly = str.substring(idx, idx + 1) + str + str.substring(idx, idx + 1);
      return silly;
    }
    ...
    */
    public String halvesReversed(String myString) {
      String reversal = myString.substring(myString.length() / 2) + myString.substring(0, myString.length() / 2);
      return reversal;
    }
  ...
  */
  public String pigLatin(String orig) {
    String NotLatin = orig.substring(1) + orig.substring(0, 1) + "ay";
    return NotLatin;
  }
  ...
  */
  public String endUp(String myString, int numToCap){
    ...
    giga = myString.substring(0 , myString.length() - numToCap) + myString.substring(myString.length() - numToCap).toUpperCase();
    } else {
    giga = myString.toUpperCase();
    }
    return giga;
  }
  ...
  */
  public String yellOrWhisper(String myString) {
    if ((myString.substring(0, 1).toUpperCase().compareTo(myString.substring(0, 1))) == 0) {
